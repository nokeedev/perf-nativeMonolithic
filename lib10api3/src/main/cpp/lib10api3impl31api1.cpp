 ...
 * Here is a function.
 */
int lib10api3impl31api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10api3impl31api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10api3impl31api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10api3impl31api14(int a, int b) {
    return a + b;
}

int Lib10Api3Impl31Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib10Api3Impl31Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10Api3Impl31Api1" << std::endl;
        Lib10Impl lib10impl;
