 ...
 * Here is a function.
 */
int lib10implimpl10api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl10api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl10api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl10api14(int a, int b) {
    return a + b;
}

int Lib10ImplImpl10Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl10Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl10Api1" << std::endl;
