 ...
 * Here is a function.
 */
int lib10implimpl12api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl12api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl12api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl12api24(int a, int b) {
    return a + b;
}

int Lib10ImplImpl12Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl12Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl12Api2" << std::endl;
