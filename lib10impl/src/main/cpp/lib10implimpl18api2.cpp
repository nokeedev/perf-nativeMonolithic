 ...
 * Here is a function.
 */
int lib10implimpl18api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl18api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl18api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl18api24(int a, int b) {
    return a + b;
}

int Lib10ImplImpl18Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl18Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl18Api2" << std::endl;
