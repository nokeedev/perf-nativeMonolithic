 ...
 * Here is a function.
 */
int lib10implimpl20api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl20api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl20api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl20api34(int a, int b) {
    return a + b;
}

int Lib10ImplImpl20Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl20Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl20Api3" << std::endl;
