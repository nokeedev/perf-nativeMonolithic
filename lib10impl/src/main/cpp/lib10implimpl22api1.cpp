 ...
 * Here is a function.
 */
int lib10implimpl22api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl22api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl22api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl22api14(int a, int b) {
    return a + b;
}

int Lib10ImplImpl22Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl22Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl22Api1" << std::endl;
