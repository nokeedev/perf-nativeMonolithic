 ...
 * Here is a function.
 */
int lib10implimpl24api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl24api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl24api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl24api24(int a, int b) {
    return a + b;
}

int Lib10ImplImpl24Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl24Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl24Api2" << std::endl;
