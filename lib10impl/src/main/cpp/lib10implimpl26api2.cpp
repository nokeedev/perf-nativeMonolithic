 ...
 * Here is a function.
 */
int lib10implimpl26api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl26api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl26api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl26api24(int a, int b) {
    return a + b;
}

int Lib10ImplImpl26Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl26Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl26Api2" << std::endl;
