 ...
 * Here is a function.
 */
int lib10implimpl2api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl2api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl2api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl2api14(int a, int b) {
    return a + b;
}

int Lib10ImplImpl2Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl2Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl2Api1" << std::endl;
