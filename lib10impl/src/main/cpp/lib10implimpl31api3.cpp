 ...
 * Here is a function.
 */
int lib10implimpl31api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl31api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl31api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl31api34(int a, int b) {
    return a + b;
}

int Lib10ImplImpl31Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl31Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl31Api3" << std::endl;
