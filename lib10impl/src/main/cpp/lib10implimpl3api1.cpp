 ...
 * Here is a function.
 */
int lib10implimpl3api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl3api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl3api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl3api14(int a, int b) {
    return a + b;
}

int Lib10ImplImpl3Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl3Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl3Api1" << std::endl;
