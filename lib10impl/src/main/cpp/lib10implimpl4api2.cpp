 ...
 * Here is a function.
 */
int lib10implimpl4api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl4api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl4api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl4api24(int a, int b) {
    return a + b;
}

int Lib10ImplImpl4Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl4Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl4Api2" << std::endl;
        ...
        Lib10ImplImpl4Impl lib10implimpl4impl;
        lib10implimpl4impl.doSomething();
