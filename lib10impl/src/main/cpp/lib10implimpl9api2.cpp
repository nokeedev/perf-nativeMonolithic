 ...
 * Here is a function.
 */
int lib10implimpl9api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl9api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl9api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib10implimpl9api24(int a, int b) {
    return a + b;
}

int Lib10ImplImpl9Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib10ImplImpl9Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib10ImplImpl9Api2" << std::endl;
        ...
        Lib10ImplImpl9Impl lib10implimpl9impl;
        lib10implimpl9impl.doSomething();
