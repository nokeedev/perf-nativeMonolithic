 ...
 * Here is a function.
 */
int lib11api3impl1api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11api3impl1api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11api3impl1api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11api3impl1api14(int a, int b) {
    return a + b;
}

int Lib11Api3Impl1Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib11Api3Impl1Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib11Api3Impl1Api1" << std::endl;
        Lib11Impl lib11impl;
