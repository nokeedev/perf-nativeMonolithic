 ...
 * Here is a function.
 */
int lib11api3impl2api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11api3impl2api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11api3impl2api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11api3impl2api34(int a, int b) {
    return a + b;
}

int Lib11Api3Impl2Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib11Api3Impl2Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib11Api3Impl2Api3" << std::endl;
        Lib11Impl lib11impl;
