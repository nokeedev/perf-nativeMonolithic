 ...
 * Here is a function.
 */
int lib11implimpl13api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl13api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl13api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl13api14(int a, int b) {
    return a + b;
}

int Lib11ImplImpl13Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib11ImplImpl13Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib11ImplImpl13Api1" << std::endl;
