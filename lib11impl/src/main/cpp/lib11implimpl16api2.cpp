 ...
 * Here is a function.
 */
int lib11implimpl16api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl16api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl16api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl16api24(int a, int b) {
    return a + b;
}

int Lib11ImplImpl16Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib11ImplImpl16Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib11ImplImpl16Api2" << std::endl;
