 ...
 * Here is a function.
 */
int lib11implimpl23api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl23api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl23api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl23api34(int a, int b) {
    return a + b;
}

int Lib11ImplImpl23Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib11ImplImpl23Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib11ImplImpl23Api3" << std::endl;
