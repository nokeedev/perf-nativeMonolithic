 ...
 * Here is a function.
 */
int lib11implimpl28api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl28api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl28api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl28api24(int a, int b) {
    return a + b;
}

int Lib11ImplImpl28Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib11ImplImpl28Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib11ImplImpl28Api2" << std::endl;
