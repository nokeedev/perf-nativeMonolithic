 ...
 * Here is a function.
 */
int lib11implimpl30api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl30api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl30api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl30api14(int a, int b) {
    return a + b;
}

int Lib11ImplImpl30Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib11ImplImpl30Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib11ImplImpl30Api1" << std::endl;
