 ...
 * Here is a function.
 */
int lib11implimpl33api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl33api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl33api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl33api24(int a, int b) {
    return a + b;
}

int Lib11ImplImpl33Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib11ImplImpl33Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib11ImplImpl33Api2" << std::endl;
