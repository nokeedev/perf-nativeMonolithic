 ...
 * Here is a function.
 */
int lib11implimpl4api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl4api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl4api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib11implimpl4api24(int a, int b) {
    return a + b;
}

int Lib11ImplImpl4Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib11ImplImpl4Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib11ImplImpl4Api2" << std::endl;
