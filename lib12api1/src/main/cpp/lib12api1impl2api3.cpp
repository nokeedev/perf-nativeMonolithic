 ...
 * Here is a function.
 */
int lib12api1impl2api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12api1impl2api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12api1impl2api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12api1impl2api34(int a, int b) {
    return a + b;
}

int Lib12Api1Impl2Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib12Api1Impl2Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib12Api1Impl2Api3" << std::endl;
        Lib13Api1 lib13api1;
