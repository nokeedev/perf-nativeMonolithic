 ...
 * Here is a function.
 */
int lib12implimpl16api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl16api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl16api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl16api34(int a, int b) {
    return a + b;
}

int Lib12ImplImpl16Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib12ImplImpl16Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib12ImplImpl16Api3" << std::endl;
