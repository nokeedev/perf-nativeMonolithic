 ...
 * Here is a function.
 */
int lib12implimpl19api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl19api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl19api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl19api34(int a, int b) {
    return a + b;
}

int Lib12ImplImpl19Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib12ImplImpl19Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib12ImplImpl19Api3" << std::endl;
