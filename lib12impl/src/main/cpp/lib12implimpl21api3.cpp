 ...
 * Here is a function.
 */
int lib12implimpl21api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl21api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl21api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl21api34(int a, int b) {
    return a + b;
}

int Lib12ImplImpl21Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib12ImplImpl21Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib12ImplImpl21Api3" << std::endl;
