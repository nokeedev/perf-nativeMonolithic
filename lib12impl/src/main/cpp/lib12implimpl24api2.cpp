 ...
 * Here is a function.
 */
int lib12implimpl24api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl24api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl24api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl24api24(int a, int b) {
    return a + b;
}

int Lib12ImplImpl24Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib12ImplImpl24Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib12ImplImpl24Api2" << std::endl;
