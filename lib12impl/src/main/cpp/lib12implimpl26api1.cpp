 ...
 * Here is a function.
 */
int lib12implimpl26api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl26api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl26api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl26api14(int a, int b) {
    return a + b;
}

int Lib12ImplImpl26Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib12ImplImpl26Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib12ImplImpl26Api1" << std::endl;
