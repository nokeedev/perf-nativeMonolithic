 ...
 * Here is a function.
 */
int lib12implimpl28api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl28api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl28api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl28api14(int a, int b) {
    return a + b;
}

int Lib12ImplImpl28Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib12ImplImpl28Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib12ImplImpl28Api1" << std::endl;
