 ...
 * Here is a function.
 */
int lib12implimpl31api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl31api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl31api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl31api14(int a, int b) {
    return a + b;
}

int Lib12ImplImpl31Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib12ImplImpl31Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib12ImplImpl31Api1" << std::endl;
