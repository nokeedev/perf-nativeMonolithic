 ...
 * Here is a function.
 */
int lib12implimpl8api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl8api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl8api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib12implimpl8api14(int a, int b) {
    return a + b;
}

int Lib12ImplImpl8Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib12ImplImpl8Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib12ImplImpl8Api1" << std::endl;
