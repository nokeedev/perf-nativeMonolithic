 ...
 * Here is a function.
 */
int lib13api1impl2api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api1impl2api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api1impl2api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api1impl2api34(int a, int b) {
    return a + b;
}

int Lib13Api1Impl2Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib13Api1Impl2Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13Api1Impl2Api3" << std::endl;
        Lib14Api1 lib14api1;
