 ...
 * Here is a function.
 */
int lib13api3impl31api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api3impl31api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api3impl31api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api3impl31api24(int a, int b) {
    return a + b;
}

int Lib13Api3Impl31Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib13Api3Impl31Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13Api3Impl31Api2" << std::endl;
        Lib13Impl lib13impl;
