 ...
 * Here is a function.
 */
int lib13api3impl32api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api3impl32api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api3impl32api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api3impl32api14(int a, int b) {
    return a + b;
}

int Lib13Api3Impl32Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib13Api3Impl32Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13Api3Impl32Api1" << std::endl;
        Lib13Impl lib13impl;
