 ...
 * Here is a function.
 */
int lib13api3impl32api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api3impl32api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api3impl32api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13api3impl32api34(int a, int b) {
    return a + b;
}

int Lib13Api3Impl32Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib13Api3Impl32Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13Api3Impl32Api3" << std::endl;
        Lib13Impl lib13impl;
