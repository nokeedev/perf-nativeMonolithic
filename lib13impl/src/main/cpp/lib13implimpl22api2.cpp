 ...
 * Here is a function.
 */
int lib13implimpl22api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl22api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl22api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl22api24(int a, int b) {
    return a + b;
}

int Lib13ImplImpl22Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl22Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl22Api2" << std::endl;
