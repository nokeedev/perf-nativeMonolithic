 ...
 * Here is a function.
 */
int lib13implimpl23api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl23api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl23api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl23api14(int a, int b) {
    return a + b;
}

int Lib13ImplImpl23Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl23Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl23Api1" << std::endl;
