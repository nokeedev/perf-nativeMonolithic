 ...
 * Here is a function.
 */
int lib13implimpl27api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl27api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl27api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl27api34(int a, int b) {
    return a + b;
}

int Lib13ImplImpl27Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl27Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl27Api3" << std::endl;
