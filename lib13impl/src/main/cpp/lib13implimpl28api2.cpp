 ...
 * Here is a function.
 */
int lib13implimpl28api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl28api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl28api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl28api24(int a, int b) {
    return a + b;
}

int Lib13ImplImpl28Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl28Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl28Api2" << std::endl;
