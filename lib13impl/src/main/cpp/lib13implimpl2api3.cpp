 ...
 * Here is a function.
 */
int lib13implimpl2api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl2api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl2api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl2api34(int a, int b) {
    return a + b;
}

int Lib13ImplImpl2Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl2Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl2Api3" << std::endl;
