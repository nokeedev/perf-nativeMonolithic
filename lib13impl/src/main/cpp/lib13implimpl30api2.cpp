 ...
 * Here is a function.
 */
int lib13implimpl30api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl30api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl30api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl30api24(int a, int b) {
    return a + b;
}

int Lib13ImplImpl30Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl30Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl30Api2" << std::endl;
