 ...
 * Here is a function.
 */
int lib13implimpl31api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl31api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl31api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl31api34(int a, int b) {
    return a + b;
}

int Lib13ImplImpl31Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl31Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl31Api3" << std::endl;
