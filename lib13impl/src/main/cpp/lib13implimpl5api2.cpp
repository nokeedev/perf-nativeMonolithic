 ...
 * Here is a function.
 */
int lib13implimpl5api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl5api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl5api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl5api24(int a, int b) {
    return a + b;
}

int Lib13ImplImpl5Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl5Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl5Api2" << std::endl;
