 ...
 * Here is a function.
 */
int lib13implimpl6api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl6api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl6api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl6api14(int a, int b) {
    return a + b;
}

int Lib13ImplImpl6Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl6Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl6Api1" << std::endl;
