 ...
 * Here is a function.
 */
int lib13implimpl7api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl7api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl7api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl7api34(int a, int b) {
    return a + b;
}

int Lib13ImplImpl7Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl7Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl7Api3" << std::endl;
