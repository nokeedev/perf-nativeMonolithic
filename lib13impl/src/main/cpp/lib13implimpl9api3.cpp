 ...
 * Here is a function.
 */
int lib13implimpl9api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl9api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl9api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib13implimpl9api34(int a, int b) {
    return a + b;
}

int Lib13ImplImpl9Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib13ImplImpl9Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib13ImplImpl9Api3" << std::endl;
