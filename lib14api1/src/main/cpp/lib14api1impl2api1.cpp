 ...
 * Here is a function.
 */
int lib14api1impl2api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api1impl2api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api1impl2api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api1impl2api14(int a, int b) {
    return a + b;
}

int Lib14Api1Impl2Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib14Api1Impl2Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14Api1Impl2Api1" << std::endl;
        Lib15Api1 lib15api1;
