 ...
 * Here is a function.
 */
int lib14api2impl24api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl24api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl24api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl24api34(int a, int b) {
    return a + b;
}

int Lib14Api2Impl24Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib14Api2Impl24Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14Api2Impl24Api3" << std::endl;
        Lib14Impl lib14impl;
