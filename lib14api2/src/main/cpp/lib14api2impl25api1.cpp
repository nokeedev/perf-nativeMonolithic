 ...
 * Here is a function.
 */
int lib14api2impl25api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl25api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl25api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl25api14(int a, int b) {
    return a + b;
}

int Lib14Api2Impl25Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib14Api2Impl25Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14Api2Impl25Api1" << std::endl;
        Lib14Impl lib14impl;
