 ...
 * Here is a function.
 */
int lib14api2impl2api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl2api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl2api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl2api24(int a, int b) {
    return a + b;
}

int Lib14Api2Impl2Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib14Api2Impl2Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14Api2Impl2Api2" << std::endl;
        Lib14Impl lib14impl;
