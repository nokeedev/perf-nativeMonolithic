 ...
 * Here is a function.
 */
int lib14api2impl32api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl32api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl32api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api2impl32api24(int a, int b) {
    return a + b;
}

int Lib14Api2Impl32Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib14Api2Impl32Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14Api2Impl32Api2" << std::endl;
        Lib14Impl lib14impl;
