 ...
 * Here is a function.
 */
int lib14api3impl20api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api3impl20api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api3impl20api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api3impl20api34(int a, int b) {
    return a + b;
}

int Lib14Api3Impl20Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib14Api3Impl20Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14Api3Impl20Api3" << std::endl;
        Lib14Impl lib14impl;
