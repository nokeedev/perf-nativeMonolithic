 ...
 * Here is a function.
 */
int lib14api3impl22api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api3impl22api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api3impl22api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14api3impl22api14(int a, int b) {
    return a + b;
}

int Lib14Api3Impl22Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib14Api3Impl22Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14Api3Impl22Api1" << std::endl;
        Lib14Impl lib14impl;
