 ...
 * Here is a function.
 */
int lib14implimpl10api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl10api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl10api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl10api24(int a, int b) {
    return a + b;
}

int Lib14ImplImpl10Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl10Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl10Api2" << std::endl;
