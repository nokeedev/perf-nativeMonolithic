 ...
 * Here is a function.
 */
int lib14implimpl11api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl11api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl11api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl11api14(int a, int b) {
    return a + b;
}

int Lib14ImplImpl11Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl11Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl11Api1" << std::endl;
