 ...
 * Here is a function.
 */
int lib14implimpl14api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl14api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl14api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl14api34(int a, int b) {
    return a + b;
}

int Lib14ImplImpl14Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl14Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl14Api3" << std::endl;
