 ...
 * Here is a function.
 */
int lib14implimpl17api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl17api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl17api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl17api14(int a, int b) {
    return a + b;
}

int Lib14ImplImpl17Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl17Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl17Api1" << std::endl;
