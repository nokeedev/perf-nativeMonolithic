 ...
 * Here is a function.
 */
int lib14implimpl18api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl18api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl18api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl18api34(int a, int b) {
    return a + b;
}

int Lib14ImplImpl18Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl18Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl18Api3" << std::endl;
