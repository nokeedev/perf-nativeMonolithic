 ...
 * Here is a function.
 */
int lib14implimpl19api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl19api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl19api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl19api34(int a, int b) {
    return a + b;
}

int Lib14ImplImpl19Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl19Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl19Api3" << std::endl;
