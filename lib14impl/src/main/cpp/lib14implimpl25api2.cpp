 ...
 * Here is a function.
 */
int lib14implimpl25api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl25api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl25api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl25api24(int a, int b) {
    return a + b;
}

int Lib14ImplImpl25Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl25Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl25Api2" << std::endl;
