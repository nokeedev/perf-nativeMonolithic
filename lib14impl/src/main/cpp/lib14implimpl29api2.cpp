 ...
 * Here is a function.
 */
int lib14implimpl29api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl29api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl29api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl29api24(int a, int b) {
    return a + b;
}

int Lib14ImplImpl29Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl29Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl29Api2" << std::endl;
