 ...
 * Here is a function.
 */
int lib14implimpl2api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl2api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl2api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl2api24(int a, int b) {
    return a + b;
}

int Lib14ImplImpl2Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl2Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl2Api2" << std::endl;
