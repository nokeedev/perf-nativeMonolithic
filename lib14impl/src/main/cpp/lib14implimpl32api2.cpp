 ...
 * Here is a function.
 */
int lib14implimpl32api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl32api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl32api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl32api24(int a, int b) {
    return a + b;
}

int Lib14ImplImpl32Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl32Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl32Api2" << std::endl;
