 ...
 * Here is a function.
 */
int lib14implimpl4api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl4api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl4api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl4api24(int a, int b) {
    return a + b;
}

int Lib14ImplImpl4Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl4Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl4Api2" << std::endl;
