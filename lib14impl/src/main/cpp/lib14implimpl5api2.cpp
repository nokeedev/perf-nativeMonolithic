 ...
 * Here is a function.
 */
int lib14implimpl5api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl5api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl5api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl5api24(int a, int b) {
    return a + b;
}

int Lib14ImplImpl5Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl5Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl5Api2" << std::endl;
