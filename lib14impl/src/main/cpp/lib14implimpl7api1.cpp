 ...
 * Here is a function.
 */
int lib14implimpl7api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl7api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl7api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib14implimpl7api14(int a, int b) {
    return a + b;
}

int Lib14ImplImpl7Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib14ImplImpl7Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib14ImplImpl7Api1" << std::endl;
