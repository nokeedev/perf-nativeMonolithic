 ...
 * Here is a function.
 */
int lib15api3impl4api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15api3impl4api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15api3impl4api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15api3impl4api24(int a, int b) {
    return a + b;
}

int Lib15Api3Impl4Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib15Api3Impl4Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15Api3Impl4Api2" << std::endl;
        Lib15Impl lib15impl;
