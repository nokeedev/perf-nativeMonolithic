 ...
 * Here is a function.
 */
int lib15implimpl17api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl17api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl17api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl17api14(int a, int b) {
    return a + b;
}

int Lib15ImplImpl17Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl17Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl17Api1" << std::endl;
