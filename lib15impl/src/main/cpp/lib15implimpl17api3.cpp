 ...
 * Here is a function.
 */
int lib15implimpl17api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl17api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl17api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl17api34(int a, int b) {
    return a + b;
}

int Lib15ImplImpl17Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl17Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl17Api3" << std::endl;
