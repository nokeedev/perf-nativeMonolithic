 ...
 * Here is a function.
 */
int lib15implimpl19api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl19api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl19api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl19api24(int a, int b) {
    return a + b;
}

int Lib15ImplImpl19Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl19Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl19Api2" << std::endl;
