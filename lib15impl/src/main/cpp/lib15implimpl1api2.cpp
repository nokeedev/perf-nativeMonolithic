 ...
 * Here is a function.
 */
int lib15implimpl1api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl1api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl1api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl1api24(int a, int b) {
    return a + b;
}

int Lib15ImplImpl1Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl1Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl1Api2" << std::endl;
