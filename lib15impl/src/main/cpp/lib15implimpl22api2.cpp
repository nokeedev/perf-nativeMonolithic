 ...
 * Here is a function.
 */
int lib15implimpl22api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl22api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl22api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl22api24(int a, int b) {
    return a + b;
}

int Lib15ImplImpl22Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl22Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl22Api2" << std::endl;
