 ...
 * Here is a function.
 */
int lib15implimpl32api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl32api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl32api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl32api24(int a, int b) {
    return a + b;
}

int Lib15ImplImpl32Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl32Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl32Api2" << std::endl;
