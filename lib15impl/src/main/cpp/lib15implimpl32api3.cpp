 ...
 * Here is a function.
 */
int lib15implimpl32api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl32api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl32api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl32api34(int a, int b) {
    return a + b;
}

int Lib15ImplImpl32Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl32Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl32Api3" << std::endl;
