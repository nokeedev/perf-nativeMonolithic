 ...
 * Here is a function.
 */
int lib15implimpl4api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl4api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl4api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl4api14(int a, int b) {
    return a + b;
}

int Lib15ImplImpl4Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl4Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl4Api1" << std::endl;
