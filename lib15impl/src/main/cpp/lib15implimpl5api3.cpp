 ...
 * Here is a function.
 */
int lib15implimpl5api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl5api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl5api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl5api34(int a, int b) {
    return a + b;
}

int Lib15ImplImpl5Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl5Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl5Api3" << std::endl;
