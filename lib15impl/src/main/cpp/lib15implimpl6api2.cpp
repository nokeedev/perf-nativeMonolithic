 ...
 * Here is a function.
 */
int lib15implimpl6api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl6api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl6api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl6api24(int a, int b) {
    return a + b;
}

int Lib15ImplImpl6Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl6Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl6Api2" << std::endl;
