 ...
 * Here is a function.
 */
int lib15implimpl7api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl7api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl7api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl7api24(int a, int b) {
    return a + b;
}

int Lib15ImplImpl7Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl7Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl7Api2" << std::endl;
