 ...
 * Here is a function.
 */
int lib15implimpl7api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl7api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl7api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl7api34(int a, int b) {
    return a + b;
}

int Lib15ImplImpl7Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl7Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl7Api3" << std::endl;
