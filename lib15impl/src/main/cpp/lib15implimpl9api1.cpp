 ...
 * Here is a function.
 */
int lib15implimpl9api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl9api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl9api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib15implimpl9api14(int a, int b) {
    return a + b;
}

int Lib15ImplImpl9Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib15ImplImpl9Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib15ImplImpl9Api1" << std::endl;
