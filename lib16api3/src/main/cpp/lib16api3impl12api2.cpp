 ...
 * Here is a function.
 */
int lib16api3impl12api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl12api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl12api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl12api24(int a, int b) {
    return a + b;
}

int Lib16Api3Impl12Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib16Api3Impl12Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16Api3Impl12Api2" << std::endl;
        Lib16Impl lib16impl;
