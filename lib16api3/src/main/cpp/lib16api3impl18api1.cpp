 ...
 * Here is a function.
 */
int lib16api3impl18api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl18api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl18api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl18api14(int a, int b) {
    return a + b;
}

int Lib16Api3Impl18Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib16Api3Impl18Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16Api3Impl18Api1" << std::endl;
        Lib16Impl lib16impl;
