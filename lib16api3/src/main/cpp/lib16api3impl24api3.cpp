 ...
 * Here is a function.
 */
int lib16api3impl24api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl24api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl24api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl24api34(int a, int b) {
    return a + b;
}

int Lib16Api3Impl24Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib16Api3Impl24Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16Api3Impl24Api3" << std::endl;
        Lib16Impl lib16impl;
