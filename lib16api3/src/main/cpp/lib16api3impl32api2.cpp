 ...
 * Here is a function.
 */
int lib16api3impl32api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl32api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl32api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl32api24(int a, int b) {
    return a + b;
}

int Lib16Api3Impl32Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib16Api3Impl32Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16Api3Impl32Api2" << std::endl;
        Lib16Impl lib16impl;
