 ...
 * Here is a function.
 */
int lib16api3impl6api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl6api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl6api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl6api14(int a, int b) {
    return a + b;
}

int Lib16Api3Impl6Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib16Api3Impl6Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16Api3Impl6Api1" << std::endl;
        Lib16Impl lib16impl;
