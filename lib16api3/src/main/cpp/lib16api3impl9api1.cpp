 ...
 * Here is a function.
 */
int lib16api3impl9api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl9api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl9api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16api3impl9api14(int a, int b) {
    return a + b;
}

int Lib16Api3Impl9Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib16Api3Impl9Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16Api3Impl9Api1" << std::endl;
        Lib16Impl lib16impl;
