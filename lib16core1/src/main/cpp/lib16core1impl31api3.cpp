 ...
 * Here is a function.
 */
int lib16core1impl31api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16core1impl31api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16core1impl31api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16core1impl31api34(int a, int b) {
    return a + b;
}

int Lib16Core1Impl31Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib16Core1Impl31Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16Core1Impl31Api3" << std::endl;
