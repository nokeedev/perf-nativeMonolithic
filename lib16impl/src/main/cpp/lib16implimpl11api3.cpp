 ...
 * Here is a function.
 */
int lib16implimpl11api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl11api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl11api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl11api34(int a, int b) {
    return a + b;
}

int Lib16ImplImpl11Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib16ImplImpl11Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16ImplImpl11Api3" << std::endl;
