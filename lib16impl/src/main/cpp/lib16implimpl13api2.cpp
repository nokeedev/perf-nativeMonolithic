 ...
 * Here is a function.
 */
int lib16implimpl13api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl13api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl13api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl13api24(int a, int b) {
    return a + b;
}

int Lib16ImplImpl13Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib16ImplImpl13Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16ImplImpl13Api2" << std::endl;
