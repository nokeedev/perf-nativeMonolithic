 ...
 * Here is a function.
 */
int lib16implimpl14api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl14api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl14api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl14api34(int a, int b) {
    return a + b;
}

int Lib16ImplImpl14Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib16ImplImpl14Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16ImplImpl14Api3" << std::endl;
