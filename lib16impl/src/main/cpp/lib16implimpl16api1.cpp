 ...
 * Here is a function.
 */
int lib16implimpl16api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl16api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl16api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl16api14(int a, int b) {
    return a + b;
}

int Lib16ImplImpl16Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib16ImplImpl16Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16ImplImpl16Api1" << std::endl;
