 ...
 * Here is a function.
 */
int lib16implimpl17api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl17api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl17api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl17api14(int a, int b) {
    return a + b;
}

int Lib16ImplImpl17Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib16ImplImpl17Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16ImplImpl17Api1" << std::endl;
