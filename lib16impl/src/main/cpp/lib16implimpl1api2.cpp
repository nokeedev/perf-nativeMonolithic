 ...
 * Here is a function.
 */
int lib16implimpl1api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl1api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl1api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl1api24(int a, int b) {
    return a + b;
}

int Lib16ImplImpl1Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib16ImplImpl1Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16ImplImpl1Api2" << std::endl;
