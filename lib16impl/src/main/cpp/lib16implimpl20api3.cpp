 ...
 * Here is a function.
 */
int lib16implimpl20api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl20api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl20api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl20api34(int a, int b) {
    return a + b;
}

int Lib16ImplImpl20Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib16ImplImpl20Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16ImplImpl20Api3" << std::endl;
