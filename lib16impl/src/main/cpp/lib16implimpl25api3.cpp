 ...
 * Here is a function.
 */
int lib16implimpl25api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl25api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl25api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl25api34(int a, int b) {
    return a + b;
}

int Lib16ImplImpl25Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib16ImplImpl25Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16ImplImpl25Api3" << std::endl;
