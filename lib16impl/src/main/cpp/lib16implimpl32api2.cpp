 ...
 * Here is a function.
 */
int lib16implimpl32api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl32api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl32api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl32api24(int a, int b) {
    return a + b;
}

int Lib16ImplImpl32Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib16ImplImpl32Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16ImplImpl32Api2" << std::endl;
