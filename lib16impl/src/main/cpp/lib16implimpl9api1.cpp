 ...
 * Here is a function.
 */
int lib16implimpl9api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl9api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl9api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib16implimpl9api14(int a, int b) {
    return a + b;
}

int Lib16ImplImpl9Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib16ImplImpl9Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib16ImplImpl9Api1" << std::endl;
