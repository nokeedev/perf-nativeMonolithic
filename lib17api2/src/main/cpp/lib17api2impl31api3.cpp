 ...
 * Here is a function.
 */
int lib17api2impl31api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17api2impl31api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17api2impl31api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17api2impl31api34(int a, int b) {
    return a + b;
}

int Lib17Api2Impl31Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib17Api2Impl31Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17Api2Impl31Api3" << std::endl;
        Lib17Core lib17core;
