 ...
 * Here is a function.
 */
int lib17coreimpl11api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl11api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl11api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl11api34(int a, int b) {
    return a + b;
}

int Lib17CoreImpl11Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib17CoreImpl11Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17CoreImpl11Api3" << std::endl;
