 ...
 * Here is a function.
 */
int lib17coreimpl18api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl18api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl18api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl18api14(int a, int b) {
    return a + b;
}

int Lib17CoreImpl18Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib17CoreImpl18Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17CoreImpl18Api1" << std::endl;
