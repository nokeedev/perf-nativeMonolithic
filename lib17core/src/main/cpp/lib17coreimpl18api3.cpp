 ...
 * Here is a function.
 */
int lib17coreimpl18api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl18api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl18api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl18api34(int a, int b) {
    return a + b;
}

int Lib17CoreImpl18Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib17CoreImpl18Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17CoreImpl18Api3" << std::endl;
