 ...
 * Here is a function.
 */
int lib17coreimpl20api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl20api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl20api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl20api24(int a, int b) {
    return a + b;
}

int Lib17CoreImpl20Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib17CoreImpl20Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17CoreImpl20Api2" << std::endl;
