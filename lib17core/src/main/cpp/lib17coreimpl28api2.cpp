 ...
 * Here is a function.
 */
int lib17coreimpl28api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl28api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl28api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl28api24(int a, int b) {
    return a + b;
}

int Lib17CoreImpl28Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib17CoreImpl28Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17CoreImpl28Api2" << std::endl;
