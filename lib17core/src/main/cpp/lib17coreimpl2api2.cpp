 ...
 * Here is a function.
 */
int lib17coreimpl2api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl2api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl2api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl2api24(int a, int b) {
    return a + b;
}

int Lib17CoreImpl2Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib17CoreImpl2Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17CoreImpl2Api2" << std::endl;
