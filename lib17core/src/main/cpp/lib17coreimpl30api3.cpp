 ...
 * Here is a function.
 */
int lib17coreimpl30api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl30api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl30api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl30api34(int a, int b) {
    return a + b;
}

int Lib17CoreImpl30Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib17CoreImpl30Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17CoreImpl30Api3" << std::endl;
