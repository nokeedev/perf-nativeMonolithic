 ...
 * Here is a function.
 */
int lib17coreimpl4api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl4api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl4api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl4api24(int a, int b) {
    return a + b;
}

int Lib17CoreImpl4Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib17CoreImpl4Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17CoreImpl4Api2" << std::endl;
