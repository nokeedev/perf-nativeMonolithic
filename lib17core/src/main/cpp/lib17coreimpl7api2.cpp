 ...
 * Here is a function.
 */
int lib17coreimpl7api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl7api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl7api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl7api24(int a, int b) {
    return a + b;
}

int Lib17CoreImpl7Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib17CoreImpl7Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17CoreImpl7Api2" << std::endl;
