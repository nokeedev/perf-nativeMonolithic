 ...
 * Here is a function.
 */
int lib17coreimpl9api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl9api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl9api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib17coreimpl9api14(int a, int b) {
    return a + b;
}

int Lib17CoreImpl9Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib17CoreImpl9Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib17CoreImpl9Api1" << std::endl;
