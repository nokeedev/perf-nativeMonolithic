 ...
 * Here is a function.
 */
int lib1api1impl3api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api1impl3api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api1impl3api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api1impl3api14(int a, int b) {
    return a + b;
}

int Lib1Api1Impl3Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api1Impl3Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api1Impl3Api1" << std::endl;
        Lib2Api1 lib2api1;
