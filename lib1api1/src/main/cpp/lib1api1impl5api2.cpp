 ...
 * Here is a function.
 */
int lib1api1impl5api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api1impl5api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api1impl5api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api1impl5api24(int a, int b) {
    return a + b;
}

int Lib1Api1Impl5Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api1Impl5Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api1Impl5Api2" << std::endl;
        Lib2Api1 lib2api1;
