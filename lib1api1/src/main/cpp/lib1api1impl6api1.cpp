 ...
 * Here is a function.
 */
int lib1api1impl6api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api1impl6api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api1impl6api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api1impl6api14(int a, int b) {
    return a + b;
}

int Lib1Api1Impl6Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api1Impl6Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api1Impl6Api1" << std::endl;
        Lib2Api1 lib2api1;
