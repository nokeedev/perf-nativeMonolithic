 ...
 * Here is a function.
 */
int lib1api2impl10api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl10api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl10api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl10api14(int a, int b) {
    return a + b;
}

int Lib1Api2Impl10Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api2Impl10Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api2Impl10Api1" << std::endl;
        Lib1Impl lib1impl;
