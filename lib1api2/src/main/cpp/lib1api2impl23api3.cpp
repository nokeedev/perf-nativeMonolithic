 ...
 * Here is a function.
 */
int lib1api2impl23api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl23api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl23api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl23api34(int a, int b) {
    return a + b;
}

int Lib1Api2Impl23Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api2Impl23Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api2Impl23Api3" << std::endl;
        Lib1Impl lib1impl;
