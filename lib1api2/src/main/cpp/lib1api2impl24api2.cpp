 ...
 * Here is a function.
 */
int lib1api2impl24api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl24api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl24api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl24api24(int a, int b) {
    return a + b;
}

int Lib1Api2Impl24Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api2Impl24Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api2Impl24Api2" << std::endl;
        Lib1Impl lib1impl;
