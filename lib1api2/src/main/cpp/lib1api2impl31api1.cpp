 ...
 * Here is a function.
 */
int lib1api2impl31api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl31api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl31api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl31api14(int a, int b) {
    return a + b;
}

int Lib1Api2Impl31Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api2Impl31Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api2Impl31Api1" << std::endl;
        Lib1Impl lib1impl;
