 ...
 * Here is a function.
 */
int lib1api2impl32api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl32api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl32api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl32api14(int a, int b) {
    return a + b;
}

int Lib1Api2Impl32Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api2Impl32Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api2Impl32Api1" << std::endl;
        Lib1Impl lib1impl;
