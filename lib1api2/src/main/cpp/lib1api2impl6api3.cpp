 ...
 * Here is a function.
 */
int lib1api2impl6api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl6api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl6api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api2impl6api34(int a, int b) {
    return a + b;
}

int Lib1Api2Impl6Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api2Impl6Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api2Impl6Api3" << std::endl;
        Lib1Impl lib1impl;
