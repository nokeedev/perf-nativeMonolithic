 ...
 * Here is a function.
 */
int lib1api3impl11api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl11api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl11api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl11api14(int a, int b) {
    return a + b;
}

int Lib1Api3Impl11Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api3Impl11Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api3Impl11Api1" << std::endl;
        Lib1Impl lib1impl;
