 ...
 * Here is a function.
 */
int lib1api3impl15api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl15api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl15api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl15api34(int a, int b) {
    return a + b;
}

int Lib1Api3Impl15Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api3Impl15Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api3Impl15Api3" << std::endl;
        Lib1Impl lib1impl;
