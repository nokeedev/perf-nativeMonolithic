 ...
 * Here is a function.
 */
int lib1api3impl26api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl26api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl26api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl26api14(int a, int b) {
    return a + b;
}

int Lib1Api3Impl26Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api3Impl26Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api3Impl26Api1" << std::endl;
        Lib1Impl lib1impl;
