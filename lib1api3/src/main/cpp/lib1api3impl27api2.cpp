 ...
 * Here is a function.
 */
int lib1api3impl27api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl27api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl27api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl27api24(int a, int b) {
    return a + b;
}

int Lib1Api3Impl27Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api3Impl27Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api3Impl27Api2" << std::endl;
        Lib1Impl lib1impl;
