 ...
 * Here is a function.
 */
int lib1api3impl30api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl30api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl30api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl30api34(int a, int b) {
    return a + b;
}

int Lib1Api3Impl30Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api3Impl30Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api3Impl30Api3" << std::endl;
        Lib1Impl lib1impl;
