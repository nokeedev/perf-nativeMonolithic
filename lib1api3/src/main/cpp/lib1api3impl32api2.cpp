 ...
 * Here is a function.
 */
int lib1api3impl32api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl32api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl32api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1api3impl32api24(int a, int b) {
    return a + b;
}

int Lib1Api3Impl32Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib1Api3Impl32Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Api3Impl32Api2" << std::endl;
        Lib1Impl lib1impl;
