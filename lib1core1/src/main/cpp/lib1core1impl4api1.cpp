 ...
 * Here is a function.
 */
int lib1core1impl4api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1core1impl4api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1core1impl4api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1core1impl4api14(int a, int b) {
    return a + b;
}

int Lib1Core1Impl4Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib1Core1Impl4Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Core1Impl4Api1" << std::endl;
