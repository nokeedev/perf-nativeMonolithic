 ...
 * Here is a function.
 */
int lib1core2impl3api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1core2impl3api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1core2impl3api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1core2impl3api14(int a, int b) {
    return a + b;
}

int Lib1Core2Impl3Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib1Core2Impl3Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1Core2Impl3Api1" << std::endl;
