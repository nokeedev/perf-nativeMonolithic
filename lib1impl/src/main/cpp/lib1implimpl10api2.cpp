 ...
 * Here is a function.
 */
int lib1implimpl10api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl10api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl10api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl10api24(int a, int b) {
    return a + b;
}

int Lib1ImplImpl10Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib1ImplImpl10Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1ImplImpl10Api2" << std::endl;
        Lib1Core1 lib1core1;
