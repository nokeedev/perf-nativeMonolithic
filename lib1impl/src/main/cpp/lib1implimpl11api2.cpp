 ...
 * Here is a function.
 */
int lib1implimpl11api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl11api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl11api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl11api24(int a, int b) {
    return a + b;
}

int Lib1ImplImpl11Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib1ImplImpl11Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1ImplImpl11Api2" << std::endl;
        Lib1Core1 lib1core1;
