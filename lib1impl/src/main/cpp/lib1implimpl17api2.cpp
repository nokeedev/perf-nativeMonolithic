 ...
 * Here is a function.
 */
int lib1implimpl17api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl17api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl17api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl17api24(int a, int b) {
    return a + b;
}

int Lib1ImplImpl17Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib1ImplImpl17Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1ImplImpl17Api2" << std::endl;
        Lib1Core1 lib1core1;
