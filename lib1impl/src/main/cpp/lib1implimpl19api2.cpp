 ...
 * Here is a function.
 */
int lib1implimpl19api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl19api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl19api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl19api24(int a, int b) {
    return a + b;
}

int Lib1ImplImpl19Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib1ImplImpl19Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1ImplImpl19Api2" << std::endl;
        Lib1Core1 lib1core1;
