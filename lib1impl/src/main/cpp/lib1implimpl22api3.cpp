 ...
 * Here is a function.
 */
int lib1implimpl22api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl22api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl22api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl22api34(int a, int b) {
    return a + b;
}

int Lib1ImplImpl22Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib1ImplImpl22Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1ImplImpl22Api3" << std::endl;
        Lib1Core1 lib1core1;
