 ...
 * Here is a function.
 */
int lib1implimpl27api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl27api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl27api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl27api34(int a, int b) {
    return a + b;
}

int Lib1ImplImpl27Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib1ImplImpl27Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1ImplImpl27Api3" << std::endl;
        Lib1Core1 lib1core1;
