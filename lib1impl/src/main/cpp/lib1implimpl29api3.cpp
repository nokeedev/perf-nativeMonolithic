 ...
 * Here is a function.
 */
int lib1implimpl29api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl29api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl29api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl29api34(int a, int b) {
    return a + b;
}

int Lib1ImplImpl29Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib1ImplImpl29Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1ImplImpl29Api3" << std::endl;
        Lib1Core1 lib1core1;
