 ...
 * Here is a function.
 */
int lib1implimpl6api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl6api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl6api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl6api24(int a, int b) {
    return a + b;
}

int Lib1ImplImpl6Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib1ImplImpl6Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1ImplImpl6Api2" << std::endl;
        Lib1Core1 lib1core1;
