 ...
 * Here is a function.
 */
int lib1implimpl7api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl7api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl7api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl7api34(int a, int b) {
    return a + b;
}

int Lib1ImplImpl7Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib1ImplImpl7Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1ImplImpl7Api3" << std::endl;
        Lib1Core1 lib1core1;
