 ...
 * Here is a function.
 */
int lib1implimpl9api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl9api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl9api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib1implimpl9api34(int a, int b) {
    return a + b;
}

int Lib1ImplImpl9Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib1ImplImpl9Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib1ImplImpl9Api3" << std::endl;
        Lib1Core1 lib1core1;
