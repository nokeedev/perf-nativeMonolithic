 ...
 * Here is a function.
 */
int lib2api2impl1api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api2impl1api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api2impl1api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api2impl1api24(int a, int b) {
    return a + b;
}

int Lib2Api2Impl1Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib2Api2Impl1Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2Api2Impl1Api2" << std::endl;
        Lib2Impl lib2impl;
