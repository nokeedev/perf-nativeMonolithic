 ...
 * Here is a function.
 */
int lib2api2impl8api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api2impl8api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api2impl8api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api2impl8api14(int a, int b) {
    return a + b;
}

int Lib2Api2Impl8Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib2Api2Impl8Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2Api2Impl8Api1" << std::endl;
        Lib2Impl lib2impl;
