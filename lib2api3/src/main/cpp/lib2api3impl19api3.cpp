 ...
 * Here is a function.
 */
int lib2api3impl19api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl19api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl19api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl19api34(int a, int b) {
    return a + b;
}

int Lib2Api3Impl19Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib2Api3Impl19Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2Api3Impl19Api3" << std::endl;
        Lib2Impl lib2impl;
