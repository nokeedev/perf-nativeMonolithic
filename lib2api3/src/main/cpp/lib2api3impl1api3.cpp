 ...
 * Here is a function.
 */
int lib2api3impl1api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl1api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl1api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl1api34(int a, int b) {
    return a + b;
}

int Lib2Api3Impl1Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib2Api3Impl1Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2Api3Impl1Api3" << std::endl;
        Lib2Impl lib2impl;
