 ...
 * Here is a function.
 */
int lib2api3impl5api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl5api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl5api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl5api34(int a, int b) {
    return a + b;
}

int Lib2Api3Impl5Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib2Api3Impl5Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2Api3Impl5Api3" << std::endl;
        Lib2Impl lib2impl;
