 ...
 * Here is a function.
 */
int lib2api3impl9api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl9api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl9api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2api3impl9api24(int a, int b) {
    return a + b;
}

int Lib2Api3Impl9Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib2Api3Impl9Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2Api3Impl9Api2" << std::endl;
        Lib2Impl lib2impl;
