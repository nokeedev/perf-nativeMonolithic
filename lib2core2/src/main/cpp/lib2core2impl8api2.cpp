 ...
 * Here is a function.
 */
int lib2core2impl8api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2core2impl8api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2core2impl8api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2core2impl8api24(int a, int b) {
    return a + b;
}

int Lib2Core2Impl8Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib2Core2Impl8Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2Core2Impl8Api2" << std::endl;
