 ...
 * Here is a function.
 */
int lib2core2impl9api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2core2impl9api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2core2impl9api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2core2impl9api14(int a, int b) {
    return a + b;
}

int Lib2Core2Impl9Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib2Core2Impl9Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2Core2Impl9Api1" << std::endl;
