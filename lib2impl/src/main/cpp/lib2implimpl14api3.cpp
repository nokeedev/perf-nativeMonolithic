 ...
 * Here is a function.
 */
int lib2implimpl14api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl14api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl14api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl14api34(int a, int b) {
    return a + b;
}

int Lib2ImplImpl14Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib2ImplImpl14Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2ImplImpl14Api3" << std::endl;
        Lib2Core1 lib2core1;
