 ...
 * Here is a function.
 */
int lib2implimpl1api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl1api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl1api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl1api24(int a, int b) {
    return a + b;
}

int Lib2ImplImpl1Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib2ImplImpl1Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2ImplImpl1Api2" << std::endl;
        Lib2Core1 lib2core1;
