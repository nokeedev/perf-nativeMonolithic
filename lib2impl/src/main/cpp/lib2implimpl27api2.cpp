 ...
 * Here is a function.
 */
int lib2implimpl27api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl27api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl27api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl27api24(int a, int b) {
    return a + b;
}

int Lib2ImplImpl27Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib2ImplImpl27Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2ImplImpl27Api2" << std::endl;
        Lib2Core1 lib2core1;
