 ...
 * Here is a function.
 */
int lib2implimpl30api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl30api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl30api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl30api14(int a, int b) {
    return a + b;
}

int Lib2ImplImpl30Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib2ImplImpl30Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2ImplImpl30Api1" << std::endl;
        Lib2Core1 lib2core1;
