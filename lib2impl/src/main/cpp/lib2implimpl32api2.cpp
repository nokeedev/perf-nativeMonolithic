 ...
 * Here is a function.
 */
int lib2implimpl32api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl32api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl32api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib2implimpl32api24(int a, int b) {
    return a + b;
}

int Lib2ImplImpl32Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib2ImplImpl32Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib2ImplImpl32Api2" << std::endl;
        Lib2Core1 lib2core1;
