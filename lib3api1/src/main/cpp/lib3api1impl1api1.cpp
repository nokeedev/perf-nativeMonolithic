 ...
 * Here is a function.
 */
int lib3api1impl1api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl1api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl1api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl1api14(int a, int b) {
    return a + b;
}

int Lib3Api1Impl1Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib3Api1Impl1Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Api1Impl1Api1" << std::endl;
        Lib4Api1 lib4api1;
