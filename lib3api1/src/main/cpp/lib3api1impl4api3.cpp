 ...
 * Here is a function.
 */
int lib3api1impl4api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl4api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl4api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl4api34(int a, int b) {
    return a + b;
}

int Lib3Api1Impl4Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib3Api1Impl4Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Api1Impl4Api3" << std::endl;
        Lib4Api1 lib4api1;
