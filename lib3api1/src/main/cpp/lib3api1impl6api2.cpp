 ...
 * Here is a function.
 */
int lib3api1impl6api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl6api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl6api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl6api24(int a, int b) {
    return a + b;
}

int Lib3Api1Impl6Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib3Api1Impl6Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Api1Impl6Api2" << std::endl;
        Lib4Api1 lib4api1;
