 ...
 * Here is a function.
 */
int lib3api1impl8api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl8api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl8api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api1impl8api24(int a, int b) {
    return a + b;
}

int Lib3Api1Impl8Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib3Api1Impl8Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Api1Impl8Api2" << std::endl;
        Lib4Api1 lib4api1;
