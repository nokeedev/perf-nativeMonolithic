 ...
 * Here is a function.
 */
int lib3api2impl6api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api2impl6api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api2impl6api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api2impl6api34(int a, int b) {
    return a + b;
}

int Lib3Api2Impl6Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib3Api2Impl6Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Api2Impl6Api3" << std::endl;
        Lib3Impl lib3impl;
