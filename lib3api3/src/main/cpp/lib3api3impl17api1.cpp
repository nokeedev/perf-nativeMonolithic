 ...
 * Here is a function.
 */
int lib3api3impl17api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl17api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl17api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl17api14(int a, int b) {
    return a + b;
}

int Lib3Api3Impl17Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib3Api3Impl17Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Api3Impl17Api1" << std::endl;
        Lib3Impl lib3impl;
