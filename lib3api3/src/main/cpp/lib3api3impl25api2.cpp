 ...
 * Here is a function.
 */
int lib3api3impl25api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl25api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl25api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl25api24(int a, int b) {
    return a + b;
}

int Lib3Api3Impl25Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib3Api3Impl25Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Api3Impl25Api2" << std::endl;
        Lib3Impl lib3impl;
