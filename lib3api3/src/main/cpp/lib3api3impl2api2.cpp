 ...
 * Here is a function.
 */
int lib3api3impl2api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl2api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl2api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl2api24(int a, int b) {
    return a + b;
}

int Lib3Api3Impl2Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib3Api3Impl2Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Api3Impl2Api2" << std::endl;
        Lib3Impl lib3impl;
