 ...
 * Here is a function.
 */
int lib3api3impl31api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl31api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl31api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl31api34(int a, int b) {
    return a + b;
}

int Lib3Api3Impl31Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib3Api3Impl31Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Api3Impl31Api3" << std::endl;
        Lib3Impl lib3impl;
