 ...
 * Here is a function.
 */
int lib3api3impl9api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl9api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl9api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3api3impl9api14(int a, int b) {
    return a + b;
}

int Lib3Api3Impl9Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib3Api3Impl9Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Api3Impl9Api1" << std::endl;
        Lib3Impl lib3impl;
