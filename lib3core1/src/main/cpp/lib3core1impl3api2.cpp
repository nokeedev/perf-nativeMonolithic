 ...
 * Here is a function.
 */
int lib3core1impl3api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3core1impl3api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3core1impl3api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3core1impl3api24(int a, int b) {
    return a + b;
}

int Lib3Core1Impl3Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib3Core1Impl3Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Core1Impl3Api2" << std::endl;
