 ...
 * Here is a function.
 */
int lib3core2impl9api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3core2impl9api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3core2impl9api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3core2impl9api24(int a, int b) {
    return a + b;
}

int Lib3Core2Impl9Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib3Core2Impl9Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3Core2Impl9Api2" << std::endl;
