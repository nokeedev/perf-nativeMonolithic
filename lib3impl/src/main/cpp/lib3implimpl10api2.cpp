 ...
 * Here is a function.
 */
int lib3implimpl10api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl10api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl10api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl10api24(int a, int b) {
    return a + b;
}

int Lib3ImplImpl10Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib3ImplImpl10Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3ImplImpl10Api2" << std::endl;
        Lib3Core1 lib3core1;
