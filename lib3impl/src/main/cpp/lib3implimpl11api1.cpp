 ...
 * Here is a function.
 */
int lib3implimpl11api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl11api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl11api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl11api14(int a, int b) {
    return a + b;
}

int Lib3ImplImpl11Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib3ImplImpl11Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3ImplImpl11Api1" << std::endl;
        Lib3Core1 lib3core1;
