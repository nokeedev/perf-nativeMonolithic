 ...
 * Here is a function.
 */
int lib3implimpl1api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl1api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl1api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl1api34(int a, int b) {
    return a + b;
}

int Lib3ImplImpl1Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib3ImplImpl1Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3ImplImpl1Api3" << std::endl;
        Lib3Core1 lib3core1;
