 ...
 * Here is a function.
 */
int lib3implimpl24api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl24api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl24api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl24api34(int a, int b) {
    return a + b;
}

int Lib3ImplImpl24Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib3ImplImpl24Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3ImplImpl24Api3" << std::endl;
        Lib3Core1 lib3core1;
