 ...
 * Here is a function.
 */
int lib3implimpl25api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl25api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl25api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl25api24(int a, int b) {
    return a + b;
}

int Lib3ImplImpl25Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib3ImplImpl25Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3ImplImpl25Api2" << std::endl;
        Lib3Core1 lib3core1;
