 ...
 * Here is a function.
 */
int lib3implimpl25api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl25api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl25api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl25api34(int a, int b) {
    return a + b;
}

int Lib3ImplImpl25Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib3ImplImpl25Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3ImplImpl25Api3" << std::endl;
        Lib3Core1 lib3core1;
