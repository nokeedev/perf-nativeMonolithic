 ...
 * Here is a function.
 */
int lib3implimpl27api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl27api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl27api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl27api24(int a, int b) {
    return a + b;
}

int Lib3ImplImpl27Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib3ImplImpl27Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3ImplImpl27Api2" << std::endl;
        Lib3Core1 lib3core1;
