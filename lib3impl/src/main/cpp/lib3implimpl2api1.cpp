 ...
 * Here is a function.
 */
int lib3implimpl2api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl2api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl2api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl2api14(int a, int b) {
    return a + b;
}

int Lib3ImplImpl2Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib3ImplImpl2Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3ImplImpl2Api1" << std::endl;
        Lib3Core1 lib3core1;
