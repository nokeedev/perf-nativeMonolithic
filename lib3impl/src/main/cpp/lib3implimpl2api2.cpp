 ...
 * Here is a function.
 */
int lib3implimpl2api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl2api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl2api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib3implimpl2api24(int a, int b) {
    return a + b;
}

int Lib3ImplImpl2Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib3ImplImpl2Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib3ImplImpl2Api2" << std::endl;
        Lib3Core1 lib3core1;
