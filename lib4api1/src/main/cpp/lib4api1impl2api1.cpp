 ...
 * Here is a function.
 */
int lib4api1impl2api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api1impl2api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api1impl2api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api1impl2api14(int a, int b) {
    return a + b;
}

int Lib4Api1Impl2Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib4Api1Impl2Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4Api1Impl2Api1" << std::endl;
        Lib5Api1 lib5api1;
