 ...
 * Here is a function.
 */
int lib4api2impl9api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api2impl9api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api2impl9api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api2impl9api24(int a, int b) {
    return a + b;
}

int Lib4Api2Impl9Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib4Api2Impl9Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4Api2Impl9Api2" << std::endl;
        Lib4Impl lib4impl;
