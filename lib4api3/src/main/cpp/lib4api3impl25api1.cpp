 ...
 * Here is a function.
 */
int lib4api3impl25api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl25api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl25api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl25api14(int a, int b) {
    return a + b;
}

int Lib4Api3Impl25Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib4Api3Impl25Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4Api3Impl25Api1" << std::endl;
        Lib4Impl lib4impl;
