 ...
 * Here is a function.
 */
int lib4api3impl31api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl31api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl31api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl31api14(int a, int b) {
    return a + b;
}

int Lib4Api3Impl31Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib4Api3Impl31Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4Api3Impl31Api1" << std::endl;
        Lib4Impl lib4impl;
