 ...
 * Here is a function.
 */
int lib4api3impl31api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl31api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl31api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl31api34(int a, int b) {
    return a + b;
}

int Lib4Api3Impl31Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib4Api3Impl31Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4Api3Impl31Api3" << std::endl;
        Lib4Impl lib4impl;
