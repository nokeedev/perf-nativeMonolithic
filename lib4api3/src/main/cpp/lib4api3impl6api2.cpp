 ...
 * Here is a function.
 */
int lib4api3impl6api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl6api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl6api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl6api24(int a, int b) {
    return a + b;
}

int Lib4Api3Impl6Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib4Api3Impl6Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4Api3Impl6Api2" << std::endl;
        Lib4Impl lib4impl;
