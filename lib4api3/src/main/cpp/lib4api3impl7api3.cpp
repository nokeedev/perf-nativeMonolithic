 ...
 * Here is a function.
 */
int lib4api3impl7api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl7api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl7api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4api3impl7api34(int a, int b) {
    return a + b;
}

int Lib4Api3Impl7Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib4Api3Impl7Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4Api3Impl7Api3" << std::endl;
        Lib4Impl lib4impl;
