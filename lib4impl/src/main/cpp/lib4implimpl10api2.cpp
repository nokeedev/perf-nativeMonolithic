 ...
 * Here is a function.
 */
int lib4implimpl10api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl10api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl10api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl10api24(int a, int b) {
    return a + b;
}

int Lib4ImplImpl10Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib4ImplImpl10Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4ImplImpl10Api2" << std::endl;
        Lib4Core1 lib4core1;
