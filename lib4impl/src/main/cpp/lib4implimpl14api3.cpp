 ...
 * Here is a function.
 */
int lib4implimpl14api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl14api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl14api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl14api34(int a, int b) {
    return a + b;
}

int Lib4ImplImpl14Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib4ImplImpl14Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4ImplImpl14Api3" << std::endl;
        Lib4Core1 lib4core1;
