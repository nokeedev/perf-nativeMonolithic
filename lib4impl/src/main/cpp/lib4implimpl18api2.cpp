 ...
 * Here is a function.
 */
int lib4implimpl18api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl18api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl18api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl18api24(int a, int b) {
    return a + b;
}

int Lib4ImplImpl18Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib4ImplImpl18Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4ImplImpl18Api2" << std::endl;
        Lib4Core1 lib4core1;
