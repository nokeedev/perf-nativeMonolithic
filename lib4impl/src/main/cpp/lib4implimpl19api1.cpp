 ...
 * Here is a function.
 */
int lib4implimpl19api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl19api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl19api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl19api14(int a, int b) {
    return a + b;
}

int Lib4ImplImpl19Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib4ImplImpl19Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4ImplImpl19Api1" << std::endl;
        Lib4Core1 lib4core1;
