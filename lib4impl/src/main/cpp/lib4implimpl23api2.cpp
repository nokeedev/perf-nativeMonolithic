 ...
 * Here is a function.
 */
int lib4implimpl23api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl23api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl23api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl23api24(int a, int b) {
    return a + b;
}

int Lib4ImplImpl23Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib4ImplImpl23Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4ImplImpl23Api2" << std::endl;
        Lib4Core1 lib4core1;
