 ...
 * Here is a function.
 */
int lib4implimpl24api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl24api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl24api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl24api34(int a, int b) {
    return a + b;
}

int Lib4ImplImpl24Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib4ImplImpl24Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4ImplImpl24Api3" << std::endl;
        Lib4Core1 lib4core1;
