 ...
 * Here is a function.
 */
int lib4implimpl8api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl8api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl8api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib4implimpl8api34(int a, int b) {
    return a + b;
}

int Lib4ImplImpl8Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib4ImplImpl8Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib4ImplImpl8Api3" << std::endl;
        Lib4Core1 lib4core1;
