 ...
 * Here is a function.
 */
int lib5api1impl2api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api1impl2api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api1impl2api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api1impl2api24(int a, int b) {
    return a + b;
}

int Lib5Api1Impl2Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib5Api1Impl2Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5Api1Impl2Api2" << std::endl;
        Lib6Api1 lib6api1;
