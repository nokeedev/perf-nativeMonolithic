 ...
 * Here is a function.
 */
int lib5api2impl25api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api2impl25api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api2impl25api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api2impl25api34(int a, int b) {
    return a + b;
}

int Lib5Api2Impl25Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib5Api2Impl25Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5Api2Impl25Api3" << std::endl;
        Lib5Impl lib5impl;
