 ...
 * Here is a function.
 */
int lib5api2impl32api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api2impl32api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api2impl32api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api2impl32api34(int a, int b) {
    return a + b;
}

int Lib5Api2Impl32Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib5Api2Impl32Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5Api2Impl32Api3" << std::endl;
        Lib5Impl lib5impl;
