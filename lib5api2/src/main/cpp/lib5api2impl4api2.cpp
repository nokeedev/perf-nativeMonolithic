 ...
 * Here is a function.
 */
int lib5api2impl4api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api2impl4api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api2impl4api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api2impl4api24(int a, int b) {
    return a + b;
}

int Lib5Api2Impl4Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib5Api2Impl4Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5Api2Impl4Api2" << std::endl;
        Lib5Impl lib5impl;
