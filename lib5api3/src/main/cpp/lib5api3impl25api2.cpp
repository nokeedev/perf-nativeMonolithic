 ...
 * Here is a function.
 */
int lib5api3impl25api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api3impl25api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api3impl25api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api3impl25api24(int a, int b) {
    return a + b;
}

int Lib5Api3Impl25Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib5Api3Impl25Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5Api3Impl25Api2" << std::endl;
        Lib5Impl lib5impl;
