 ...
 * Here is a function.
 */
int lib5api3impl4api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api3impl4api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api3impl4api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api3impl4api14(int a, int b) {
    return a + b;
}

int Lib5Api3Impl4Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib5Api3Impl4Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5Api3Impl4Api1" << std::endl;
        Lib5Impl lib5impl;
