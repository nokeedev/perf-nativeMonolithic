 ...
 * Here is a function.
 */
int lib5api3impl7api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api3impl7api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api3impl7api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5api3impl7api34(int a, int b) {
    return a + b;
}

int Lib5Api3Impl7Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib5Api3Impl7Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5Api3Impl7Api3" << std::endl;
        Lib5Impl lib5impl;
