 ...
 * Here is a function.
 */
int lib5implimpl10api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl10api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl10api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl10api24(int a, int b) {
    return a + b;
}

int Lib5ImplImpl10Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib5ImplImpl10Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5ImplImpl10Api2" << std::endl;
        Lib5Core1 lib5core1;
