 ...
 * Here is a function.
 */
int lib5implimpl13api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl13api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl13api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl13api24(int a, int b) {
    return a + b;
}

int Lib5ImplImpl13Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib5ImplImpl13Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5ImplImpl13Api2" << std::endl;
        Lib5Core1 lib5core1;
