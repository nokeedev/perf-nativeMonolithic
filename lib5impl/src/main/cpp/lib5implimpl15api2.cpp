 ...
 * Here is a function.
 */
int lib5implimpl15api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl15api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl15api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl15api24(int a, int b) {
    return a + b;
}

int Lib5ImplImpl15Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib5ImplImpl15Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5ImplImpl15Api2" << std::endl;
        Lib5Core1 lib5core1;
