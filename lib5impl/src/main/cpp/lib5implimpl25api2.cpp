 ...
 * Here is a function.
 */
int lib5implimpl25api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl25api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl25api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl25api24(int a, int b) {
    return a + b;
}

int Lib5ImplImpl25Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib5ImplImpl25Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5ImplImpl25Api2" << std::endl;
        Lib5Core1 lib5core1;
