 ...
 * Here is a function.
 */
int lib5implimpl28api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl28api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl28api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl28api34(int a, int b) {
    return a + b;
}

int Lib5ImplImpl28Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib5ImplImpl28Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5ImplImpl28Api3" << std::endl;
        Lib5Core1 lib5core1;
