 ...
 * Here is a function.
 */
int lib5implimpl29api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl29api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl29api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl29api24(int a, int b) {
    return a + b;
}

int Lib5ImplImpl29Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib5ImplImpl29Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5ImplImpl29Api2" << std::endl;
        Lib5Core1 lib5core1;
