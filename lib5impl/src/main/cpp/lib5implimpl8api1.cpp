 ...
 * Here is a function.
 */
int lib5implimpl8api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl8api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl8api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl8api14(int a, int b) {
    return a + b;
}

int Lib5ImplImpl8Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib5ImplImpl8Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5ImplImpl8Api1" << std::endl;
        Lib5Core1 lib5core1;
