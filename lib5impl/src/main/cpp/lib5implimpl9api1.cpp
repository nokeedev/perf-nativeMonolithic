 ...
 * Here is a function.
 */
int lib5implimpl9api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl9api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl9api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl9api14(int a, int b) {
    return a + b;
}

int Lib5ImplImpl9Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib5ImplImpl9Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5ImplImpl9Api1" << std::endl;
        Lib5Core1 lib5core1;
