 ...
 * Here is a function.
 */
int lib5implimpl9api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl9api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl9api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib5implimpl9api24(int a, int b) {
    return a + b;
}

int Lib5ImplImpl9Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib5ImplImpl9Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib5ImplImpl9Api2" << std::endl;
        Lib5Core1 lib5core1;
