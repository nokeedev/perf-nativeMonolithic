 ...
 * Here is a function.
 */
int lib6api1impl1api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api1impl1api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api1impl1api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api1impl1api14(int a, int b) {
    return a + b;
}

int Lib6Api1Impl1Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api1Impl1Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api1Impl1Api1" << std::endl;
        Lib7Api1 lib7api1;
