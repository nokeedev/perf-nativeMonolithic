 ...
 * Here is a function.
 */
int lib6api1impl5api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api1impl5api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api1impl5api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api1impl5api34(int a, int b) {
    return a + b;
}

int Lib6Api1Impl5Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api1Impl5Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api1Impl5Api3" << std::endl;
        Lib7Api1 lib7api1;
