 ...
 * Here is a function.
 */
int lib6api1impl7api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api1impl7api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api1impl7api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api1impl7api24(int a, int b) {
    return a + b;
}

int Lib6Api1Impl7Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api1Impl7Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api1Impl7Api2" << std::endl;
        Lib7Api1 lib7api1;
