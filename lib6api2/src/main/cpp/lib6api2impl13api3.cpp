 ...
 * Here is a function.
 */
int lib6api2impl13api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl13api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl13api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl13api34(int a, int b) {
    return a + b;
}

int Lib6Api2Impl13Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api2Impl13Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api2Impl13Api3" << std::endl;
        Lib6Impl lib6impl;
