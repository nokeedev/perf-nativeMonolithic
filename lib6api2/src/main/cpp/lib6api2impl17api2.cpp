 ...
 * Here is a function.
 */
int lib6api2impl17api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl17api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl17api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl17api24(int a, int b) {
    return a + b;
}

int Lib6Api2Impl17Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api2Impl17Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api2Impl17Api2" << std::endl;
        Lib6Impl lib6impl;
