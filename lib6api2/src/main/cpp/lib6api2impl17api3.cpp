 ...
 * Here is a function.
 */
int lib6api2impl17api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl17api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl17api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl17api34(int a, int b) {
    return a + b;
}

int Lib6Api2Impl17Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api2Impl17Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api2Impl17Api3" << std::endl;
        Lib6Impl lib6impl;
