 ...
 * Here is a function.
 */
int lib6api2impl25api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl25api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl25api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl25api14(int a, int b) {
    return a + b;
}

int Lib6Api2Impl25Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api2Impl25Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api2Impl25Api1" << std::endl;
        Lib6Impl lib6impl;
