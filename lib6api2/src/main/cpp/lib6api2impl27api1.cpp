 ...
 * Here is a function.
 */
int lib6api2impl27api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl27api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl27api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl27api14(int a, int b) {
    return a + b;
}

int Lib6Api2Impl27Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api2Impl27Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api2Impl27Api1" << std::endl;
        Lib6Impl lib6impl;
