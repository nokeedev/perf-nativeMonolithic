 ...
 * Here is a function.
 */
int lib6api2impl27api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl27api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl27api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl27api34(int a, int b) {
    return a + b;
}

int Lib6Api2Impl27Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api2Impl27Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api2Impl27Api3" << std::endl;
        Lib6Impl lib6impl;
