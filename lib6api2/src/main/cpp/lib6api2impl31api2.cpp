 ...
 * Here is a function.
 */
int lib6api2impl31api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl31api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl31api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl31api24(int a, int b) {
    return a + b;
}

int Lib6Api2Impl31Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api2Impl31Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api2Impl31Api2" << std::endl;
        Lib6Impl lib6impl;
