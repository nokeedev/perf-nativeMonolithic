 ...
 * Here is a function.
 */
int lib6api2impl9api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl9api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl9api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api2impl9api34(int a, int b) {
    return a + b;
}

int Lib6Api2Impl9Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api2Impl9Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api2Impl9Api3" << std::endl;
        Lib6Impl lib6impl;
