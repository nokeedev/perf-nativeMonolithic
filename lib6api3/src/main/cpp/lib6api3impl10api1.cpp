 ...
 * Here is a function.
 */
int lib6api3impl10api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl10api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl10api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl10api14(int a, int b) {
    return a + b;
}

int Lib6Api3Impl10Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api3Impl10Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api3Impl10Api1" << std::endl;
        Lib6Impl lib6impl;
