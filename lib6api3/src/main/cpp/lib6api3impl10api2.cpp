 ...
 * Here is a function.
 */
int lib6api3impl10api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl10api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl10api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl10api24(int a, int b) {
    return a + b;
}

int Lib6Api3Impl10Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api3Impl10Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api3Impl10Api2" << std::endl;
        Lib6Impl lib6impl;
