 ...
 * Here is a function.
 */
int lib6api3impl12api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl12api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl12api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl12api24(int a, int b) {
    return a + b;
}

int Lib6Api3Impl12Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api3Impl12Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api3Impl12Api2" << std::endl;
        Lib6Impl lib6impl;
