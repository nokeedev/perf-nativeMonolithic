 ...
 * Here is a function.
 */
int lib6api3impl29api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl29api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl29api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl29api24(int a, int b) {
    return a + b;
}

int Lib6Api3Impl29Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api3Impl29Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api3Impl29Api2" << std::endl;
        Lib6Impl lib6impl;
