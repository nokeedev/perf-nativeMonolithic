 ...
 * Here is a function.
 */
int lib6api3impl2api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl2api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl2api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl2api24(int a, int b) {
    return a + b;
}

int Lib6Api3Impl2Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api3Impl2Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api3Impl2Api2" << std::endl;
        Lib6Impl lib6impl;
