 ...
 * Here is a function.
 */
int lib6api3impl31api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl31api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl31api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl31api14(int a, int b) {
    return a + b;
}

int Lib6Api3Impl31Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api3Impl31Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api3Impl31Api1" << std::endl;
        Lib6Impl lib6impl;
