 ...
 * Here is a function.
 */
int lib6api3impl8api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl8api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl8api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6api3impl8api34(int a, int b) {
    return a + b;
}

int Lib6Api3Impl8Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6Api3Impl8Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Api3Impl8Api3" << std::endl;
        Lib6Impl lib6impl;
