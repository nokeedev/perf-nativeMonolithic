 ...
 * Here is a function.
 */
int lib6core1impl3api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6core1impl3api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6core1impl3api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6core1impl3api34(int a, int b) {
    return a + b;
}

int Lib6Core1Impl3Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6Core1Impl3Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6Core1Impl3Api3" << std::endl;
