 ...
 * Here is a function.
 */
int lib6implimpl10api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl10api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl10api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl10api34(int a, int b) {
    return a + b;
}

int Lib6ImplImpl10Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl10Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl10Api3" << std::endl;
        Lib6Core1 lib6core1;
