 ...
 * Here is a function.
 */
int lib6implimpl19api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl19api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl19api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl19api24(int a, int b) {
    return a + b;
}

int Lib6ImplImpl19Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl19Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl19Api2" << std::endl;
        Lib6Core1 lib6core1;
