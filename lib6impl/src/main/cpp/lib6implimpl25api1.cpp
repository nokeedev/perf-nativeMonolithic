 ...
 * Here is a function.
 */
int lib6implimpl25api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl25api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl25api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl25api14(int a, int b) {
    return a + b;
}

int Lib6ImplImpl25Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl25Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl25Api1" << std::endl;
        Lib6Core1 lib6core1;
