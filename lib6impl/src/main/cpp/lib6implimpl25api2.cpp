 ...
 * Here is a function.
 */
int lib6implimpl25api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl25api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl25api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl25api24(int a, int b) {
    return a + b;
}

int Lib6ImplImpl25Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl25Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl25Api2" << std::endl;
        Lib6Core1 lib6core1;
