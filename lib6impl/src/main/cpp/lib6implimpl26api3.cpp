 ...
 * Here is a function.
 */
int lib6implimpl26api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl26api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl26api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl26api34(int a, int b) {
    return a + b;
}

int Lib6ImplImpl26Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl26Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl26Api3" << std::endl;
        Lib6Core1 lib6core1;
