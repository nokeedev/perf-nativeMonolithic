 ...
 * Here is a function.
 */
int lib6implimpl28api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl28api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl28api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl28api14(int a, int b) {
    return a + b;
}

int Lib6ImplImpl28Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl28Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl28Api1" << std::endl;
        Lib6Core1 lib6core1;
