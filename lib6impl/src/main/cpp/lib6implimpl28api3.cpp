 ...
 * Here is a function.
 */
int lib6implimpl28api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl28api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl28api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl28api34(int a, int b) {
    return a + b;
}

int Lib6ImplImpl28Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl28Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl28Api3" << std::endl;
        Lib6Core1 lib6core1;
