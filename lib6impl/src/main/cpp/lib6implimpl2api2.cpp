 ...
 * Here is a function.
 */
int lib6implimpl2api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl2api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl2api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl2api24(int a, int b) {
    return a + b;
}

int Lib6ImplImpl2Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl2Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl2Api2" << std::endl;
        Lib6Core1 lib6core1;
