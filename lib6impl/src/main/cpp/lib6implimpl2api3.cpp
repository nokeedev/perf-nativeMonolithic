 ...
 * Here is a function.
 */
int lib6implimpl2api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl2api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl2api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl2api34(int a, int b) {
    return a + b;
}

int Lib6ImplImpl2Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl2Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl2Api3" << std::endl;
        Lib6Core1 lib6core1;
