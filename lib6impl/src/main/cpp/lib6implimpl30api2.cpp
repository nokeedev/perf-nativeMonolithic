 ...
 * Here is a function.
 */
int lib6implimpl30api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl30api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl30api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl30api24(int a, int b) {
    return a + b;
}

int Lib6ImplImpl30Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl30Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl30Api2" << std::endl;
        Lib6Core1 lib6core1;
