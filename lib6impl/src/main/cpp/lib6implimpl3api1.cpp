 ...
 * Here is a function.
 */
int lib6implimpl3api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl3api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl3api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl3api14(int a, int b) {
    return a + b;
}

int Lib6ImplImpl3Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl3Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl3Api1" << std::endl;
        Lib6Core1 lib6core1;
