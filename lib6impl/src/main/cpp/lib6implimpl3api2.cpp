 ...
 * Here is a function.
 */
int lib6implimpl3api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl3api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl3api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl3api24(int a, int b) {
    return a + b;
}

int Lib6ImplImpl3Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl3Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl3Api2" << std::endl;
        Lib6Core1 lib6core1;
