 ...
 * Here is a function.
 */
int lib6implimpl5api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl5api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl5api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl5api34(int a, int b) {
    return a + b;
}

int Lib6ImplImpl5Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl5Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl5Api3" << std::endl;
        Lib6Core1 lib6core1;
