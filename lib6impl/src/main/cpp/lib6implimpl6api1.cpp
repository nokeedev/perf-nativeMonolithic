 ...
 * Here is a function.
 */
int lib6implimpl6api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl6api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl6api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib6implimpl6api14(int a, int b) {
    return a + b;
}

int Lib6ImplImpl6Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib6ImplImpl6Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib6ImplImpl6Api1" << std::endl;
        Lib6Core1 lib6core1;
