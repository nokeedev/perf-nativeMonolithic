 ...
 * Here is a function.
 */
int lib7api1impl1api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api1impl1api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api1impl1api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api1impl1api14(int a, int b) {
    return a + b;
}

int Lib7Api1Impl1Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib7Api1Impl1Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Api1Impl1Api1" << std::endl;
        Lib8Api1 lib8api1;
