 ...
 * Here is a function.
 */
int lib7api1impl5api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api1impl5api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api1impl5api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api1impl5api34(int a, int b) {
    return a + b;
}

int Lib7Api1Impl5Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib7Api1Impl5Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Api1Impl5Api3" << std::endl;
        Lib8Api1 lib8api1;
