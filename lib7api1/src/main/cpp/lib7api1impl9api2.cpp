 ...
 * Here is a function.
 */
int lib7api1impl9api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api1impl9api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api1impl9api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api1impl9api24(int a, int b) {
    return a + b;
}

int Lib7Api1Impl9Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib7Api1Impl9Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Api1Impl9Api2" << std::endl;
        Lib8Api1 lib8api1;
