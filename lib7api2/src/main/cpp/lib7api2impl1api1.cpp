 ...
 * Here is a function.
 */
int lib7api2impl1api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api2impl1api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api2impl1api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api2impl1api14(int a, int b) {
    return a + b;
}

int Lib7Api2Impl1Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib7Api2Impl1Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Api2Impl1Api1" << std::endl;
        Lib7Impl lib7impl;
