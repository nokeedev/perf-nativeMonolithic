 ...
 * Here is a function.
 */
int lib7api2impl3api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api2impl3api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api2impl3api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api2impl3api24(int a, int b) {
    return a + b;
}

int Lib7Api2Impl3Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib7Api2Impl3Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Api2Impl3Api2" << std::endl;
        Lib7Impl lib7impl;
