 ...
 * Here is a function.
 */
int lib7api2impl4api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api2impl4api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api2impl4api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api2impl4api14(int a, int b) {
    return a + b;
}

int Lib7Api2Impl4Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib7Api2Impl4Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Api2Impl4Api1" << std::endl;
        Lib7Impl lib7impl;
