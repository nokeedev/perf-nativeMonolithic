 ...
 * Here is a function.
 */
int lib7api3impl27api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api3impl27api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api3impl27api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api3impl27api34(int a, int b) {
    return a + b;
}

int Lib7Api3Impl27Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib7Api3Impl27Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Api3Impl27Api3" << std::endl;
        Lib7Impl lib7impl;
