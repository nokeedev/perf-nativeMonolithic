 ...
 * Here is a function.
 */
int lib7api3impl5api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api3impl5api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api3impl5api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7api3impl5api14(int a, int b) {
    return a + b;
}

int Lib7Api3Impl5Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib7Api3Impl5Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Api3Impl5Api1" << std::endl;
        Lib7Impl lib7impl;
