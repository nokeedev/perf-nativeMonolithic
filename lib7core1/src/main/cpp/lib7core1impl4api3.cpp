 ...
 * Here is a function.
 */
int lib7core1impl4api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7core1impl4api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7core1impl4api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7core1impl4api34(int a, int b) {
    return a + b;
}

int Lib7Core1Impl4Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib7Core1Impl4Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Core1Impl4Api3" << std::endl;
