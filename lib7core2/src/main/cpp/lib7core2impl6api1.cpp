 ...
 * Here is a function.
 */
int lib7core2impl6api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7core2impl6api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7core2impl6api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7core2impl6api14(int a, int b) {
    return a + b;
}

int Lib7Core2Impl6Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib7Core2Impl6Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Core2Impl6Api1" << std::endl;
