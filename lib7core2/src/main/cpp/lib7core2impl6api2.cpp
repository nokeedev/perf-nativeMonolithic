 ...
 * Here is a function.
 */
int lib7core2impl6api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7core2impl6api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7core2impl6api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7core2impl6api24(int a, int b) {
    return a + b;
}

int Lib7Core2Impl6Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib7Core2Impl6Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7Core2Impl6Api2" << std::endl;
