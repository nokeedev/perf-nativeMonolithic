 ...
 * Here is a function.
 */
int lib7implimpl16api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl16api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl16api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl16api14(int a, int b) {
    return a + b;
}

int Lib7ImplImpl16Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl16Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl16Api1" << std::endl;
        Lib7Core1 lib7core1;
