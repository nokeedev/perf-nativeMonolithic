 ...
 * Here is a function.
 */
int lib7implimpl20api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl20api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl20api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl20api34(int a, int b) {
    return a + b;
}

int Lib7ImplImpl20Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl20Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl20Api3" << std::endl;
        Lib7Core1 lib7core1;
