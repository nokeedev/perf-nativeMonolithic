 ...
 * Here is a function.
 */
int lib7implimpl22api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl22api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl22api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl22api24(int a, int b) {
    return a + b;
}

int Lib7ImplImpl22Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl22Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl22Api2" << std::endl;
        Lib7Core1 lib7core1;
