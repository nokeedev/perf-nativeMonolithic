 ...
 * Here is a function.
 */
int lib7implimpl22api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl22api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl22api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl22api34(int a, int b) {
    return a + b;
}

int Lib7ImplImpl22Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl22Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl22Api3" << std::endl;
        Lib7Core1 lib7core1;
