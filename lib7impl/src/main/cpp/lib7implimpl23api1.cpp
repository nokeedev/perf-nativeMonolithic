 ...
 * Here is a function.
 */
int lib7implimpl23api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl23api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl23api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl23api14(int a, int b) {
    return a + b;
}

int Lib7ImplImpl23Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl23Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl23Api1" << std::endl;
        Lib7Core1 lib7core1;
