 ...
 * Here is a function.
 */
int lib7implimpl23api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl23api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl23api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl23api34(int a, int b) {
    return a + b;
}

int Lib7ImplImpl23Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl23Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl23Api3" << std::endl;
        Lib7Core1 lib7core1;
