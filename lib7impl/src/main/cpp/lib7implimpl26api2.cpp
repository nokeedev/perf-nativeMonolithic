 ...
 * Here is a function.
 */
int lib7implimpl26api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl26api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl26api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl26api24(int a, int b) {
    return a + b;
}

int Lib7ImplImpl26Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl26Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl26Api2" << std::endl;
        Lib7Core1 lib7core1;
