 ...
 * Here is a function.
 */
int lib7implimpl27api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl27api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl27api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl27api14(int a, int b) {
    return a + b;
}

int Lib7ImplImpl27Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl27Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl27Api1" << std::endl;
        Lib7Core1 lib7core1;
