 ...
 * Here is a function.
 */
int lib7implimpl31api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl31api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl31api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl31api24(int a, int b) {
    return a + b;
}

int Lib7ImplImpl31Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl31Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl31Api2" << std::endl;
        Lib7Core1 lib7core1;
