 ...
 * Here is a function.
 */
int lib7implimpl32api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl32api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl32api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl32api34(int a, int b) {
    return a + b;
}

int Lib7ImplImpl32Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl32Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl32Api3" << std::endl;
        Lib7Core1 lib7core1;
