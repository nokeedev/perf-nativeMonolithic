 ...
 * Here is a function.
 */
int lib7implimpl3api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl3api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl3api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl3api34(int a, int b) {
    return a + b;
}

int Lib7ImplImpl3Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl3Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl3Api3" << std::endl;
        Lib7Core1 lib7core1;
