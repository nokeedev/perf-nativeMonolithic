 ...
 * Here is a function.
 */
int lib7implimpl5api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl5api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl5api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib7implimpl5api14(int a, int b) {
    return a + b;
}

int Lib7ImplImpl5Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib7ImplImpl5Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib7ImplImpl5Api1" << std::endl;
        Lib7Core1 lib7core1;
