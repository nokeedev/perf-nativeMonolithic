 ...
 * Here is a function.
 */
int lib8api1impl2api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api1impl2api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api1impl2api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api1impl2api14(int a, int b) {
    return a + b;
}

int Lib8Api1Impl2Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib8Api1Impl2Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8Api1Impl2Api1" << std::endl;
        Lib9Api1 lib9api1;
