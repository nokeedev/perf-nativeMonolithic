 ...
 * Here is a function.
 */
int lib8api1impl4api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api1impl4api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api1impl4api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api1impl4api24(int a, int b) {
    return a + b;
}

int Lib8Api1Impl4Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib8Api1Impl4Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8Api1Impl4Api2" << std::endl;
        Lib9Api1 lib9api1;
