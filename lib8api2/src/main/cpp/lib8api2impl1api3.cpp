 ...
 * Here is a function.
 */
int lib8api2impl1api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api2impl1api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api2impl1api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api2impl1api34(int a, int b) {
    return a + b;
}

int Lib8Api2Impl1Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib8Api2Impl1Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8Api2Impl1Api3" << std::endl;
        Lib8Impl lib8impl;
