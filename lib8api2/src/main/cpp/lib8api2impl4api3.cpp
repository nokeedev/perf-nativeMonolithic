 ...
 * Here is a function.
 */
int lib8api2impl4api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api2impl4api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api2impl4api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api2impl4api34(int a, int b) {
    return a + b;
}

int Lib8Api2Impl4Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib8Api2Impl4Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8Api2Impl4Api3" << std::endl;
        Lib8Impl lib8impl;
