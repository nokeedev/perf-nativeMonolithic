 ...
 * Here is a function.
 */
int lib8api3impl24api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl24api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl24api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl24api24(int a, int b) {
    return a + b;
}

int Lib8Api3Impl24Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib8Api3Impl24Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8Api3Impl24Api2" << std::endl;
        Lib8Impl lib8impl;
