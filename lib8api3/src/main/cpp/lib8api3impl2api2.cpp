 ...
 * Here is a function.
 */
int lib8api3impl2api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl2api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl2api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl2api24(int a, int b) {
    return a + b;
}

int Lib8Api3Impl2Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib8Api3Impl2Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8Api3Impl2Api2" << std::endl;
        Lib8Impl lib8impl;
