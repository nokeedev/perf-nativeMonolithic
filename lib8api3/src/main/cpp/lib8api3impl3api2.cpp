 ...
 * Here is a function.
 */
int lib8api3impl3api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl3api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl3api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl3api24(int a, int b) {
    return a + b;
}

int Lib8Api3Impl3Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib8Api3Impl3Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8Api3Impl3Api2" << std::endl;
        Lib8Impl lib8impl;
