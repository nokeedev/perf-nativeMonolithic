 ...
 * Here is a function.
 */
int lib8api3impl3api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl3api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl3api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8api3impl3api34(int a, int b) {
    return a + b;
}

int Lib8Api3Impl3Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib8Api3Impl3Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8Api3Impl3Api3" << std::endl;
        Lib8Impl lib8impl;
