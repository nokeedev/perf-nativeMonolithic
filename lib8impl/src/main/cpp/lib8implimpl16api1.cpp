 ...
 * Here is a function.
 */
int lib8implimpl16api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl16api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl16api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl16api14(int a, int b) {
    return a + b;
}

int Lib8ImplImpl16Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib8ImplImpl16Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8ImplImpl16Api1" << std::endl;
        Lib8Core1 lib8core1;
