 ...
 * Here is a function.
 */
int lib8implimpl20api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl20api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl20api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl20api14(int a, int b) {
    return a + b;
}

int Lib8ImplImpl20Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib8ImplImpl20Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8ImplImpl20Api1" << std::endl;
        Lib8Core1 lib8core1;
