 ...
 * Here is a function.
 */
int lib8implimpl24api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl24api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl24api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl24api14(int a, int b) {
    return a + b;
}

int Lib8ImplImpl24Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib8ImplImpl24Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8ImplImpl24Api1" << std::endl;
        Lib8Core1 lib8core1;
