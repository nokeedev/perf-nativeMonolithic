 ...
 * Here is a function.
 */
int lib8implimpl26api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl26api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl26api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl26api14(int a, int b) {
    return a + b;
}

int Lib8ImplImpl26Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib8ImplImpl26Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8ImplImpl26Api1" << std::endl;
        Lib8Core1 lib8core1;
