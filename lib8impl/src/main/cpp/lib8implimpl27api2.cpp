 ...
 * Here is a function.
 */
int lib8implimpl27api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl27api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl27api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl27api24(int a, int b) {
    return a + b;
}

int Lib8ImplImpl27Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib8ImplImpl27Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8ImplImpl27Api2" << std::endl;
        Lib8Core1 lib8core1;
