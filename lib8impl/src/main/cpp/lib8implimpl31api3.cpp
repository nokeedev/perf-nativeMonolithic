 ...
 * Here is a function.
 */
int lib8implimpl31api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl31api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl31api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl31api34(int a, int b) {
    return a + b;
}

int Lib8ImplImpl31Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib8ImplImpl31Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8ImplImpl31Api3" << std::endl;
        Lib8Core1 lib8core1;
