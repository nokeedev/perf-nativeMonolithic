 ...
 * Here is a function.
 */
int lib8implimpl3api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl3api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl3api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl3api34(int a, int b) {
    return a + b;
}

int Lib8ImplImpl3Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib8ImplImpl3Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8ImplImpl3Api3" << std::endl;
        Lib8Core1 lib8core1;
