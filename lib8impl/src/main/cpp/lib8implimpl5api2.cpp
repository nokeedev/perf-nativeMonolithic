 ...
 * Here is a function.
 */
int lib8implimpl5api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl5api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl5api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl5api24(int a, int b) {
    return a + b;
}

int Lib8ImplImpl5Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib8ImplImpl5Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8ImplImpl5Api2" << std::endl;
        Lib8Core1 lib8core1;
