 ...
 * Here is a function.
 */
int lib8implimpl7api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl7api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl7api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl7api14(int a, int b) {
    return a + b;
}

int Lib8ImplImpl7Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib8ImplImpl7Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8ImplImpl7Api1" << std::endl;
        Lib8Core1 lib8core1;
