 ...
 * Here is a function.
 */
int lib8implimpl8api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl8api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl8api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib8implimpl8api24(int a, int b) {
    return a + b;
}

int Lib8ImplImpl8Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib8ImplImpl8Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib8ImplImpl8Api2" << std::endl;
        Lib8Core1 lib8core1;
