 ...
 * Here is a function.
 */
int lib9api1impl9api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api1impl9api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api1impl9api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api1impl9api14(int a, int b) {
    return a + b;
}

int Lib9Api1Impl9Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api1Impl9Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api1Impl9Api1" << std::endl;
        Lib10Api1 lib10api1;
