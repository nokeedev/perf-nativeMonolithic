 ...
 * Here is a function.
 */
int lib9api1impl9api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api1impl9api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api1impl9api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api1impl9api24(int a, int b) {
    return a + b;
}

int Lib9Api1Impl9Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api1Impl9Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api1Impl9Api2" << std::endl;
        Lib10Api1 lib10api1;
