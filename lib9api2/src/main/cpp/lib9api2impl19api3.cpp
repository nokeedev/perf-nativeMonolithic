 ...
 * Here is a function.
 */
int lib9api2impl19api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api2impl19api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api2impl19api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api2impl19api34(int a, int b) {
    return a + b;
}

int Lib9Api2Impl19Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api2Impl19Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api2Impl19Api3" << std::endl;
        Lib9Impl lib9impl;
