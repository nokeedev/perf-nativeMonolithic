 ...
 * Here is a function.
 */
int lib9api2impl20api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api2impl20api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api2impl20api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api2impl20api14(int a, int b) {
    return a + b;
}

int Lib9Api2Impl20Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api2Impl20Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api2Impl20Api1" << std::endl;
        Lib9Impl lib9impl;
