 ...
 * Here is a function.
 */
int lib9api2impl3api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api2impl3api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api2impl3api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api2impl3api34(int a, int b) {
    return a + b;
}

int Lib9Api2Impl3Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api2Impl3Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api2Impl3Api3" << std::endl;
        Lib9Impl lib9impl;
