 ...
 * Here is a function.
 */
int lib9api3impl16api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl16api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl16api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl16api24(int a, int b) {
    return a + b;
}

int Lib9Api3Impl16Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api3Impl16Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api3Impl16Api2" << std::endl;
        Lib9Impl lib9impl;
