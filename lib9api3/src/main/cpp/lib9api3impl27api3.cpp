 ...
 * Here is a function.
 */
int lib9api3impl27api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl27api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl27api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl27api34(int a, int b) {
    return a + b;
}

int Lib9Api3Impl27Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api3Impl27Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api3Impl27Api3" << std::endl;
        Lib9Impl lib9impl;
