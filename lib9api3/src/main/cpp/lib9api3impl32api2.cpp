 ...
 * Here is a function.
 */
int lib9api3impl32api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl32api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl32api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl32api24(int a, int b) {
    return a + b;
}

int Lib9Api3Impl32Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api3Impl32Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api3Impl32Api2" << std::endl;
        Lib9Impl lib9impl;
