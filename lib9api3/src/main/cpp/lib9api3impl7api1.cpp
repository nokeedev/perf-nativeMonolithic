 ...
 * Here is a function.
 */
int lib9api3impl7api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl7api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl7api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl7api14(int a, int b) {
    return a + b;
}

int Lib9Api3Impl7Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api3Impl7Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api3Impl7Api1" << std::endl;
        Lib9Impl lib9impl;
