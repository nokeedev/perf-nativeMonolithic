 ...
 * Here is a function.
 */
int lib9api3impl8api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl8api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl8api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl8api14(int a, int b) {
    return a + b;
}

int Lib9Api3Impl8Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api3Impl8Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api3Impl8Api1" << std::endl;
        Lib9Impl lib9impl;
