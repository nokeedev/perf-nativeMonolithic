 ...
 * Here is a function.
 */
int lib9api3impl8api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl8api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl8api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9api3impl8api24(int a, int b) {
    return a + b;
}

int Lib9Api3Impl8Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib9Api3Impl8Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Api3Impl8Api2" << std::endl;
        Lib9Impl lib9impl;
