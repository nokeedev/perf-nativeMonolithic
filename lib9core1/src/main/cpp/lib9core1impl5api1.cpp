 ...
 * Here is a function.
 */
int lib9core1impl5api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core1impl5api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core1impl5api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core1impl5api14(int a, int b) {
    return a + b;
}

int Lib9Core1Impl5Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib9Core1Impl5Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Core1Impl5Api1" << std::endl;
