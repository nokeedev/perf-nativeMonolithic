 ...
 * Here is a function.
 */
int lib9core1impl6api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core1impl6api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core1impl6api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core1impl6api24(int a, int b) {
    return a + b;
}

int Lib9Core1Impl6Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib9Core1Impl6Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Core1Impl6Api2" << std::endl;
