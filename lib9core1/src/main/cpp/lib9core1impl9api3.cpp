 ...
 * Here is a function.
 */
int lib9core1impl9api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core1impl9api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core1impl9api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core1impl9api34(int a, int b) {
    return a + b;
}

int Lib9Core1Impl9Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib9Core1Impl9Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Core1Impl9Api3" << std::endl;
