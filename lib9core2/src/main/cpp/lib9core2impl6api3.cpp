 ...
 * Here is a function.
 */
int lib9core2impl6api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core2impl6api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core2impl6api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core2impl6api34(int a, int b) {
    return a + b;
}

int Lib9Core2Impl6Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib9Core2Impl6Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Core2Impl6Api3" << std::endl;
