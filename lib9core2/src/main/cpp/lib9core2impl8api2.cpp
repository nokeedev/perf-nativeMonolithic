 ...
 * Here is a function.
 */
int lib9core2impl8api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core2impl8api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core2impl8api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9core2impl8api24(int a, int b) {
    return a + b;
}

int Lib9Core2Impl8Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib9Core2Impl8Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9Core2Impl8Api2" << std::endl;
