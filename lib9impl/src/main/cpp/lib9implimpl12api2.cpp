 ...
 * Here is a function.
 */
int lib9implimpl12api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl12api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl12api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl12api24(int a, int b) {
    return a + b;
}

int Lib9ImplImpl12Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib9ImplImpl12Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9ImplImpl12Api2" << std::endl;
        Lib9Core1 lib9core1;
