 ...
 * Here is a function.
 */
int lib9implimpl15api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl15api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl15api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl15api24(int a, int b) {
    return a + b;
}

int Lib9ImplImpl15Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib9ImplImpl15Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9ImplImpl15Api2" << std::endl;
        Lib9Core1 lib9core1;
