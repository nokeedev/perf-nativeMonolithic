 ...
 * Here is a function.
 */
int lib9implimpl1api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl1api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl1api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl1api14(int a, int b) {
    return a + b;
}

int Lib9ImplImpl1Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib9ImplImpl1Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9ImplImpl1Api1" << std::endl;
        Lib9Core1 lib9core1;
