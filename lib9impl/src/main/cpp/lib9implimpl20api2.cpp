 ...
 * Here is a function.
 */
int lib9implimpl20api21(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl20api22(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl20api23(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl20api24(int a, int b) {
    return a + b;
}

int Lib9ImplImpl20Api2::visited = 0;

/*
 * Here is a function.
 */
void Lib9ImplImpl20Api2::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9ImplImpl20Api2" << std::endl;
        Lib9Core1 lib9core1;
