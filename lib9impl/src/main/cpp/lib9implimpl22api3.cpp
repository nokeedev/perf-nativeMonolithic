 ...
 * Here is a function.
 */
int lib9implimpl22api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl22api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl22api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl22api34(int a, int b) {
    return a + b;
}

int Lib9ImplImpl22Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib9ImplImpl22Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9ImplImpl22Api3" << std::endl;
        Lib9Core1 lib9core1;
