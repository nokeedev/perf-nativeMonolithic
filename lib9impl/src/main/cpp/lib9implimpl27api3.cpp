 ...
 * Here is a function.
 */
int lib9implimpl27api31(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl27api32(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl27api33(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl27api34(int a, int b) {
    return a + b;
}

int Lib9ImplImpl27Api3::visited = 0;

/*
 * Here is a function.
 */
void Lib9ImplImpl27Api3::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9ImplImpl27Api3" << std::endl;
        Lib9Core1 lib9core1;
