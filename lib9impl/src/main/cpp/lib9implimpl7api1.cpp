 ...
 * Here is a function.
 */
int lib9implimpl7api11(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl7api12(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl7api13(int a, int b) {
    return a + b;
}
 ...
 * Here is a function.
 */
int lib9implimpl7api14(int a, int b) {
    return a + b;
}

int Lib9ImplImpl7Api1::visited = 0;

/*
 * Here is a function.
 */
void Lib9ImplImpl7Api1::doSomething() {
    if (visited == 0) {
        std::cout << "visit Lib9ImplImpl7Api1" << std::endl;
        Lib9Core1 lib9core1;
